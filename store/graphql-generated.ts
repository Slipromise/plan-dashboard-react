...
export type GetPlanMemberAndSearchUserQuery = {
  __typename?: "Query";
  users: Array<{
    __typename?: "User";
    name: string;
...
export type GetPlanMemberAndTaskMemberQuery = {
  __typename?: "Query";
  plan: {
    __typename?: "Plan";
    members: Array<{
...
export type GetPlanTasksQuery = {
  ...
  tasks: Array<{
    ...
    participatorsLength?: number | null | undefined;
    commentsLength?: number | null | undefined;
    bucket: string;
    status: TaskStatus;
    statusOptions: Array<TaskStatus>;
    participators?:
  ...
  me: {
    ...
    plans?:
      | Array<{
          ...
          id: string;
          members: Array<{ __typename?: "User"; name: string }>;
        }>
      | null
      | undefined;
  };
...
export type GetSidebarDataQuery = {
  __typename?: "Query";
  me: {
    __typename?: "User";
    name: string;
    avatar?: string | null | undefined;
    plans?:
      | Array<{ __typename?: "Plan"; name: string; id: string }>
      | null
      | undefined;
  };
};
...
export type GetTaskParticipatorsQuery = {
  __typename?: "Query";
  task: {
    __typename?: "Task";
    participators?:
...
export type GetTokenQuery = {
  __typename?: "Query";
  me: { __typename?: "User"; authToken?: string | null | undefined };
};
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    GetPlanMemberAndSearchUser: build.query<
      GetPlanMemberAndSearchUserQuery,
      GetPlanMemberAndSearchUserQueryVariables
    >({
      query: (variables) => ({
        document: GetPlanMemberAndSearchUserDocument,
        variables,
      }),
    }),
    GetPlanMemberAndTaskMember: build.query<
      GetPlanMemberAndTaskMemberQuery,
      GetPlanMemberAndTaskMemberQueryVariables
    >({
      query: (variables) => ({
        document: GetPlanMemberAndTaskMemberDocument,
        variables,
      }),
    }),
    GetPlanTasks: build.query<
      GetPlanTasksQuery,
      GetPlanTasksQueryVariables | void
    >({
      query: (variables) => ({ document: GetPlanTasksDocument, variables }),
    }),
    GetSelfPlans: build.query<
      GetSelfPlansQuery,
      GetSelfPlansQueryVariables | void
    >({
      query: (variables) => ({ document: GetSelfPlansDocument, variables }),
    }),
    GetSelfTasks: build.query<
      GetSelfTasksQuery,
      GetSelfTasksQueryVariables | void
    >({
      query: (variables) => ({ document: GetSelfTasksDocument, variables }),
    }),
    GetSelfUser: build.query<
      GetSelfUserQuery,
      GetSelfUserQueryVariables | void
    >({
      query: (variables) => ({ document: GetSelfUserDocument, variables }),
    }),
    GetSidebarData: build.query<
      GetSidebarDataQuery,
      GetSidebarDataQueryVariables | void
    >({
    ...
    GetTaskParticipators: build.query<
      GetTaskParticipatorsQuery,
      GetTaskParticipatorsQueryVariables
    >({
      query: (variables) => ({
        document: GetTaskParticipatorsDocument,
        variables,
      }),
    }),
...
export const {
  ...
  useGetPlanQuery,
  useLazyGetPlanQuery,
  useGetPlanMemberAndSearchUserQuery,
  useLazyGetPlanMemberAndSearchUserQuery,
  useGetPlanMemberAndTaskMemberQuery,
  useLazyGetPlanMemberAndTaskMemberQuery,
  useGetPlanTasksQuery,
  useLazyGetPlanTasksQuery,
  useGetSelfPlansQuery,
  useLazyGetSelfPlansQuery,
  useGetSelfTasksQuery,
  useLazyGetSelfTasksQuery,
  useGetSelfUserQuery,
  useLazyGetSelfUserQuery,
  useGetSidebarDataQuery,
  useLazyGetSidebarDataQuery,
  useGetTaskCommentsQuery,
  useLazyGetTaskCommentsQuery,
  useGetTaskParticipatorsQuery,
  useLazyGetTaskParticipatorsQuery,
  useGetTokenQuery,
